...
PACKAGES=('http://mirror-kt.neolabs.kz/debian/pool/main/i/iceweasel/iceweasel_4.0.1-2_i386.deb'
		...
		'http://mail.kazgrid.kz/repo/equinox-themes/equinox-themes_1.30.2-3_all.deb'
		'http://mail.kazgrid.kz/repo/equinox-themes-extra/equinox-themes-extra_1.30.2-1_all.deb'
		'http://mail.kazgrid.kz/repo/gtk2-engines-equinox/gtk2-engines-equinox_1.40-1_i386.deb'
		'http://mail.kazgrid.kz/repo/faenza-icon-theme/faenza-icon-theme_0.9.2-0.1_all.deb'
		'http://mail.kazgrid.kz/repo/faenza-cupertino-icon-theme/faenza-cupertino-icon-theme_0.1-1_all.deb'
